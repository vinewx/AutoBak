...
exports.default = (app) => {
    ...
    route.post('/envs', (0, celebrate_1.celebrate)({
    ...
    route.put('/envs', (0, celebrate_1.celebrate)({
    ...
    route.delete('/envs', (0, celebrate_1.celebrate)({
    ...
    route.put('/envs/:id/move', (0, celebrate_1.celebrate)({
    ...
    route.put('/envs/disable', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/envs/enable', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/envs/name', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
    ...
    route.get('/envs/:id', (0, celebrate_1.celebrate)({
        params: celebrate_1.Joi.object({
            id: celebrate_1.Joi.string().required(),
        }),
    }), async (req, res, next) => {
