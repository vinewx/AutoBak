...
let NotificationService = class NotificationService {
    ...
    async notify(title, content) {
        const _a = await this.authService.getNotificationMode(), { type } = _a, rest = __rest(_a, ["type"]);
        if (type) {
            this.title = title;
...
__decorate([
    (0, typedi_1.Inject)((type) => auth_1.default),
    __metadata("design:type", auth_1.default)
], NotificationService.prototype, "authService", void 0);
